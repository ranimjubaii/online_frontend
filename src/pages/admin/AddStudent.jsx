...
export default function AddStudent() {
  ...
  return (
    <div className="bg-light min-vh-100 overflow-x-hidden">
      ...
      <div style={{ marginLeft: sidebarOpen ? "260px" : "0px", paddingLeft: !sidebarOpen ? "60px" : "0px", transition: "all 0.25s ease-in-out", minHeight: "100vh" }}>
        <div className="d-flex align-items-center justify-content-between px-5 py-4 bg-white border-bottom border-light shadow-2xs">
          <button onClick={() => navigate("/admin/students")} className="btn btn-light rounded-pill px-3 py-2 small d-flex align-items-center gap-2 border">
            <FaArrowLeft size={12} /> Back to Directory
          </button>
          <span className="badge bg-opacity-10 text-uppercase tracking-wider px-3 py-2 rounded-pill fw-bold" style={{ backgroundColor: "rgba(114, 47, 55, 0.08)", color: "#722f37", fontSize: "11px" }}>
            Identity Administration Engine
          </span>
        </div>
        <div className="px-5 py-5" style={{ maxWidth: "1000px" }}>
          <div className="mb-5">
            <h1 className="fw-black tracking-tight text-dark mb-1" style={{ fontSize: "2rem" }}>Register New Student</h1>
            <p className="text-secondary small fw-medium mb-0">Provision baseline credential properties safely into the application security schema layers.</p>
          </div>
            ...
            <div className="card-body p-5">
              <form onSubmit={handleAddStudent}>
                ...
                <div className="d-flex gap-3 mt-5">
                  <button type="submit" className="btn btn-dark text-white px-5 py-3 rounded-pill shadow-sm fw-semibold d-flex align-items-center gap-2" style={{ fontSize: "14px" }}>
