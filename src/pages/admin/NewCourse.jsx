  ...
  return (
    <div className="bg-light min-vh-100 overflow-x-hidden">
      ...
      >
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 px-3 px-md-5 py-3 py-md-4 bg-white border-bottom border-light shadow-2xs">
          <div className="d-flex align-items-center gap-3">
            ...
            <span
              ...
              style={{ backgroundColor: wineRedBg, color: wineRed, fontSize: "11px" }}
            >
        ...
        <div className="px-3 px-md-5 py-4 py-md-5">
          <div className="d-flex align-items-start align-items-md-center gap-3 mb-4 mb-md-5">
            <button
              type="button"
              onClick={() => navigate("/admin/courses")}
              className="btn btn-light border shadow-2xs rounded-circle p-0 d-flex align-items-center justify-content-center flex-shrink-0"
            ...
            <div>
              <h1 className="fw-black tracking-tight text-dark mb-1" style={{ fontSize: "clamp(1.4rem, 5vw, 2rem)" }}>
                Deploy New Course Blueprint
              </h1>
              <p className="text-secondary small fw-medium mb-0">
                Build out a fresh core configuration and save it directly into the server cluster database matrices.
              </p>
            </div>
          </div>
              ...
              <form onSubmit={handleCreateCourse}>
                <div className="row g-3 g-md-4">
                  ...
                  <div className="col-12">
                    ...
                    <div className="d-flex flex-wrap align-items-center gap-3 bg-light p-3 rounded-3 border-0">
                      <label
                        className="btn btn-secondary text-white btn-sm px-3 py-2 rounded-pill d-flex align-items-center gap-2 mb-0 cursor-pointer"
                        style={{ fontSize: "13px" }}
                      >
                ...
                <div className="d-flex flex-wrap gap-3 mt-4 mt-md-5">
                  <button
                    type="submit"
                    className="btn text-white px-4 px-md-5 py-3 rounded-pill shadow-sm fw-semibold"
